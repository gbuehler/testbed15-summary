...
The Portrayal Framework ER describes the OPF requirements, test scenario, high-level architecture, and prototype solutions that were developed. Further, this ER along with companion ERs document a set of emerging specifications that support interoperable portrayal of heterogeneous geospatial data. 
